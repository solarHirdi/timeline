...
function drawVisualization() {
    ...
    const element = document.getElementById('mytimeline');
    if (element) var timeline = new Timeline(element);
    else throw new Error('Could not find container element for Timeline initialization');
